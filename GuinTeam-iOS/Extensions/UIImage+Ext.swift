...
extension UIImage {
    ...
    static func appSymbol(_ name: SymbolConstant) -> UIImage {
        let symbol = UIImage(named: name.rawValue)
        return symbol ?? emptyPlaceHolder()
    }
    
    static func appSymbol(_ name: SymbolConstant, color: UIColor) -> UIImage {
